...
export const getAllProducts = async (req, res, next) => {
  ...
  const searchresults = await getAllProductsRepo(page, name);
  res.status(200).json({
    searchresults,
  });
};
...
export const deleteReview = async (req, res, next) => {
  // Insert the essential code into this controller wherever
  // necessary to resolve issues related to removing reviews and updating product ratings.
  try {
